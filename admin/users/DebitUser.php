    ...
    <section>
        <div class="fundform container pt-5">
            <div class="container enclose p-4 bg-light">
                <h5 class="text-center section">Debit this user</h5>
                <form action="./debit.php" method="post">
                    ...
                    <div class="amount mb-3">
                        <label class="ml-0" for="amount">Amount to Debit</label>
                        <input class="form-control" type="tel" placeholder="Enter the amount" name="amount" id="">
                    </div>

                    <div class="submit mb-3"> <input class="form-control py-1  btn btn-primary" type="submit" name="submit" value="Debit Account" id="">
                    </div>
